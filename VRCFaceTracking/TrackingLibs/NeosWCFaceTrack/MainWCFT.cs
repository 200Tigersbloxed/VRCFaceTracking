...
namespace VRCFaceTracking.TrackingLibs.NeosWCFaceTrack
{
    public class MainWCFT : ITrackingModule
    {
        ...
        public class WCFTData
        {
            ...
            public Vector3 HeadPosition = Vector3.zero; // Head Position
        ...
        {
            Vector2 Look = new Vector2(data.LookLeftRight, data.LookUpDown);
        ...
        public void Update()
        {
            ...
            if (cws.ReadyState == WebSocketState.Open)
            {
                ...
                if (WCFTParser.IsMessageValid(splitData))
                {
                    ...
                    LipData_v2 fakeLipData = new LipData_v2();
                    fakeLipData.prediction_data.blend_shape_weight = new float[40];
                    fakeLipData.prediction_data.blend_shape_weight[4] = newWCFTData.MouthOpen;
                    fakeLipData.prediction_data.blend_shape_weight[13] = newWCFTData.MouthWide;
                    fakeLipData.prediction_data.blend_shape_weight[14] = newWCFTData.MouthWide;
                    Dictionary<LipShape_v2, float> fakeLipShapes = new Dictionary<LipShape_v2, float>()
                    {
                        [LipShape_v2.JawOpen] = newWCFTData.MouthOpen,
                        [LipShape_v2.MouthSmileLeft] = newWCFTData.MouthWide,
                        [LipShape_v2.MouthSmileRight] = newWCFTData.MouthWide
                    };
                    UnifiedTrackingData.LatestLipData = fakeLipData;
                    UnifiedTrackingData.LatestLipShapes = fakeLipShapes;
                }
                else
                    MelonLogger.Warning("Invalid NeosWCFT data received! Data: " + lastData);
            }
        }
